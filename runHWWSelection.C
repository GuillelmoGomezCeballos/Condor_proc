...
#include "Analysis/SelMods/interface/ZXEvtSelMod.h"
#include "Analysis/SelMods/interface/ttEvtSelMod.h"
#include "Analysis/SelMods/interface/ttljetsEvtSelMod.h"
#include "Analysis/SelMods/interface/ZllEvtSelMod.h"
#include "Analysis/SelMods/interface/ZttEvtSelMod.h"
#include "Analysis/SelMods/interface/WlnEvtSelMod.h"
...
void runHWWSelection(const char *catalogDir   = "~/scratch0/catalog",
		     const char *book	      = "cern/filefi/029",
                     const char *dataset      = "s12-wwj-v7a",
                     const char *fileset      = "0000",
                     int nsel = 220, int NEvents = 100)
{
  ...
  if     (nsel ==  1){
    ...
    files[0]   = "/castor/cern.ch/user/p/paus/filefi/029/s12-wwj-v7a/28DCA073-84D4-E111-A8D0-F04DA23BCE4C.root";
    files[0] = "/afs/cern.ch/work/a/anlevin/public/forGuillelmo19Dec2013/XX-MITDATASET-XX_000.root";
    //addLheWeights = true;
  ...
  HwwMakeNtupleMod0->SetAddLheWeights(addLheWeights);
  ...
  HwwMakeNtupleMod1->SetAddLheWeights(addLheWeights);
  ...
  HwwMakeNtupleMod2->SetAddLheWeights(addLheWeights);
  ...
  HwwMakeNtupleMod3->SetAddLheWeights(addLheWeights);
